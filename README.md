...
if you intend to install this driver make suer you connect sda to gpio 2 and scl to gpio 3
...
every bit in your input represents a pixel -0 is off and 1 is on, the driver takes 1024 pixles (an SH1106 oled is 128 by 64 pixels=8192 bits=1024 bytes)
